...
| ID | Task | Deps | Status |
|---|---|---|---|
| NT-011 | Add OneSignal XCFramework 5.x via Swift Package Manager | — | ✅ moved to CMP migration feature |
...
| NT-016 | Enable "Background Modes → Remote notifications" capability in Xcode | — | ✅ moved to CMP migration feature |
